    ...
    <div class="col-md ">
        <div class="container login-container">
            <div class="login-form">
                ...
                <br>
                <form onSubmit="return validateForm()" action="logininsert.php" enctype="multipart/form-data" method="post"> 
                    <div class="form-group">
                        <label for="username"><i class="fas fa-user"></i> Full Name </label>
                        <input type="text" class="form-control" id="fname" name="Fullname" placeholder="Enter your Full Name" required>
                    </div>
                    <div class="form-group">
                        <label for="email"><i class="fa-solid fa-envelope" style="color: #000000;"></i> DOB </label>
                        <input type="date" class="form-control" id="Dob" name="Dob" required>
                    </div>
                    <div class="form-group">
                        <label for="email"><i class="fa-solid fa-person-half-dress" style="color: #000000;"></i> Gender </label>
                       <p>  Male<input type="radio" class="form-control " id="male" name="Gender" value="male" required>
                            Female <input type="radio" class="form-control" id="female" name="Gender" value="female" required>
                        </p>
                    </div>
                    <div class="form-group">
